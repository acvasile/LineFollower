// (C) 2018 Vasile Alexandru-Catalin 333CC
// PM project for line follower
// ------------------------------------------------------
// Be advised! NOT an open license project!
// Any attempt to reproduce this source code is forbidden
...
#define SLEEP_BETWEEN	15		// Sleep between loops

#define NOISE_THRESHOLD 50		// Values bellow this are not valid
#define ON_TRACK_VALUE	200		// Above this value 


#define BASE_SPEED		175		// Base speed of motors
#define MAX_SPEED		240		// Maximum speed of motors

// Integral is to be reset after the number of iters is reached
...
// Following constants are related to each other
// but they are influenced by BASE_SPEED and MAX_SPEED
// + SLEEP_BETWEEN
...
int read_qrt_line(int *values)
{
	...
	if (!on_track)
	{
		...
		if (last_value < (SENSOR_NUM - 1) * 500)
		{
			return 0;
		}
